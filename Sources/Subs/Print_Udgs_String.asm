...
;-------------------------------------------------------------------------------
; Purpose:
; - Prints a string of user defined character by directly addressing screen
;   memory
;
...
;
; Notes:
; - This sub has a sister, called Merge_Udgs_String, which should merge the UDG
;   with what is already on the screen, but it has not been written yet.
