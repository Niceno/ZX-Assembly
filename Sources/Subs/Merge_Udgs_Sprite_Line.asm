...
;   > Merge_Udgs_Sprite_Line  (this one)
;   > Merge_Udgs_Tile_Line    (like this but chars are repetitive)
;   > Print_Udgs_Sprite_Line  (like this but chars are printed)
;   > Print_Udgs_Tile_Line    (like this but chars are printed & repetitive)
;-------------------------------------------------------------------------------
Merge_Udgs_Sprite_Line:
