...
;   > Merge_Udgs_Line_Sprite  (like this but chars are non-repetive)
;   > Merge_Udgs_Line_Tile    (this one)
;   > Print_Udgs_Line_Sprite  (like this but chars are printed & non-repetitive)
;   > Print_Udgs_Line_Tile    (like this but chars are printed)
;-------------------------------------------------------------------------------
Merge_Udgs_Line_Tile:
